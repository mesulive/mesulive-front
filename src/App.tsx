...
const App = () => {
  ...
  const {breakpoint_tablet, breakpoint_desktop} =
    useMemo(() => ({
  ...
  useEffect(() => {
    GA.trackPageView({path: window.location.pathname + window.location.search});
  }, []);
  ...
  return (
    <>
      ...
      <div className={cx("container", {"navi-active": breakpoint_desktop <= width ? true : naviActive})}>
        ...
        <footer>
          Copyright 2022. mesulive All rights reserved.<br/>
          mesulive is not associated with NEXON Korea.<br/>
