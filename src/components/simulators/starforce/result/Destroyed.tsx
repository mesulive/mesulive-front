...
const Destroyed = () => {
  ...
  useEffect(() => {
    if (simNum !== 1) {
      ...
      setTopPct((Math.round(i / destroyedArr.length * 100 * 1000) / 1000).toString());
    }
                  ...
                  handleChange={({target: {value: str}}) => {
                    ...
                    if (value !== "") {
                      ...
                      if (0 <= c) {
                        ...
                        if (i === 0) setTopPct("");
                        else if (i === destroyedArr.length && destroyedArr[i - 1] === destroyedArr[destroyedArr.length - 1]) setTopPct("100");
                        else setTopPct((Math.round(i / destroyedArr.length * 100 * 1000) / 1000).toString());
                      }
                    }
                  }}
                />
