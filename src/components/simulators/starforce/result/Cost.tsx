...
const Cost = () => {
  ...
  useEffect(() => {
    if (simNum !== 1) {
      ...
      setTopPct((Math.round(i / costArr.length * 100 * 1000) / 1000).toString());
    }
  }, [avg, costArr, simNum]);
                ...
                handleChange={({target: {value: str}}) => {
                  ...
                  if (value !== "") {
                    ...
                    if (0 < c) {
                      ...
                      if (i === 0) setTopPct("");
                      else if (i === costArr.length && costArr[i - 1] === costArr[costArr.length - 1]) setTopPct("100");
                      else setTopPct((Math.round(i / costArr.length * 100 * 1000) / 1000).toString());
                    }
                  }
                }}
              />
